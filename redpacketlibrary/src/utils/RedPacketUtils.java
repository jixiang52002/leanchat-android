...
public class RedPacketUtils {
    ...
    public static boolean checkSendRPData(Map<String, Object> attrs) { /*防止崩潰，先檢查數據*/
        if (attrs == null || !attrs.containsKey("redpacket")) return false;
        return true;
    }

    public static boolean checkReceivedRPData(Map<String, Object> attrs) { /*防止崩潰，先檢查數據*/
        if (!attrs.containsKey(RPConstant.EXTRA_LUCKY_MONEY_SENDER) || !attrs.containsKey(RPConstant.EXTRA_LUCKY_MONEY_RECEIVER) || !attrs.containsKey(RPConstant.EXTRA_LUCKY_MONEY_SENDER_ID) || !attrs.containsKey(RedPacketUtils.CHAT_TYPE))
            return false;
        return true;
    }
